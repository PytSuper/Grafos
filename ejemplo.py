...
class Grafo:
    ...
    def agregar_arista(self, u, v, peso=1):
        # Asegurar que ambos vertices existen en el grafo
...
if __name__ == "__main__":
    ...
    camino_inexistente = mi_grafo.encontrar_camino('Managua', 'Jinotepe')
    print(f"Camino de Managua a Jinotepe: {camino_inexistente}")
